...
router.get(
  ...
  async (request: Request, response: Response) => {
    try {
      ...
      logger.error("GET /stats/student/overview error", error);
...
router.get(
  ...
  async (request: Request, response: Response) => {
    try {
      ...
      logger.error("GET /stats/student/charts error", error);
      response.status(500).json({
        success: false,
...
router.get(
  ...
  async (request: Request, response: Response) => {
    try {
      ...
      logger.error("GET /stats/student/activity error", error);
      response.status(500).json({
        success: false,
